...
class CircuitdataTest < Minitest::Test
  def test_validate_json
    ...
    fail_enforced_rst = {:error => true, :message => "The product to check did not meet the requirements", :errors => {:validation => {}, :restricted => {}, :enforced => {"#/open_trade_transfer_package/products/testproduct/printed_circuits_fabrication_data/legend/color" => ["value \"yellow\" did not match one of the following values: red"]}, :capabilities => {}}}
